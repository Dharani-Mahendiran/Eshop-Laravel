    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4 class='d-flex align-items-center justify-content-between'>Add Product
            ...
            <div class="card-body">
                ...
                <form action="{{url('admin/product')}}" method='POST' enctype="multipart/form-data">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="checkbox" name='trending' onchange="toggleTrending()">
                        <span id="trendingSpan" class="text-info">Common</span>
                    </div>
